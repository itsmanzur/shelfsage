<?php
/**
 * Vault Single Layout - Style 1 (Standard)
    ...
    <div class="rmss-container min-h-screen pb-20 font-sans">
        ...
        <div class="max-w-7xl mx-auto px-4 mt-6">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="lg:w-3/5 p-8 lg:p-12 flex flex-col">
                        ...
                        <?php if ($author): ?>
                            <div class="inline-flex bg-gray-50 border border-gray-200 rounded-full pr-6 pl-2 py-1 mb-6 w-max">
                                <div class="flex flex-col leading-none">
                                    <span class="text-[10px] text-gray-400 uppercase font-bold tracking-wider"><?php echo esc_html(trsss_vault_get_label('author', __('Author', 'shelfsage-pro'), $labels)); ?></span>
                        ...
                        <div class="flex flex-col mb-6 border-b border-gray-100 pb-6">
                            <?php if ($old_price || $price): ?>
                                <div class="rmss-single-price text-gray-900 flex items-baseline gap-2">
                                    ...
                                    <?php if ($price): ?><span class="text-xl font-bold text-gray-900"><?php echo wp_kses_post($price); ?></span><?php endif; ?>
                                </div>
                            <?php endif; ?>
                            <?php if ($rating): ?>
                        ...
                        <div class="mt-auto">
                            <?php if ($link): ?>
                                <a href="<?php echo esc_url($link); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 bg-gray-900 hover:bg-black text-white font-bold py-2.5 px-6 rounded-full shadow-lg hover:shadow-xl transition-all">
            ...
            <?php if (get_the_content()): ?>
                <div class="mt-10 bg-white rounded-2xl shadow-lg p-8 lg:p-12">
