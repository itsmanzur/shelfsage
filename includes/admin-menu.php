...
function trsss_enqueue_admin_scripts()
{
    ...
    if ( file_exists( TRSSS_PATH . 'assets/custom/ss-admin-custom.js' ) ) {
        wp_enqueue_script( 'trsss-react-chunk', $custom_chunk, array(), TRSSS_VERSION ?? '1.0.0', true );
        wp_enqueue_script( 'trsss-admin-custom', $custom_admin, array( 'trsss-react-chunk' ), TRSSS_VERSION ?? '1.0.0', true );
    }
